...
namespace TaglibSharp.Tests.Images
{
	...
	{
		private static readonly string sample_file = TestPath.Samples + "sample_nikon2.jpg";
		private static readonly string tmp_file = TestPath.Samples + "tmpwrite_nikon2.jpg";
