...
namespace TaglibSharp.Tests.TaggingFormats
{
	...
	public class MovieIdTagTest
	{
		...
		private delegate void TagTestFunc (TagLib.Riff.MovieIdTag tag, string msg);

		private void TagTestWithSave (ref TagLib.Riff.MovieIdTag tag, TagTestFunc testFunc)
		{
